        ...
        return(
            <Animatable.View animation={this.props.move} duration={1500} style={styles.cardone}>
                <TouchableOpacity style={styles.box1} onPress={this.props.screenchange}>
                    <View style={{borderRadius:500,backgroundColor:'rgba(300, 300, 300, 300);',height:'100%',flex:1,alignItems:'center',justifyContent:'center'}}>
                        <Image style={{height :'60%',width:'30%'}} source={this.props.image}/>
                    </View>
                </TouchableOpacity>
